...
void CSPString::FreeData(CSPStringData* pData)
{
	delete[] (BYTE*)pData;
}
...
void  CSPString::Release(CSPStringData* pData)
{
...
CSPString  operator+(const CSPString& string1, const CSPString& string2)
{
	CSPString s;
...
CSPString  operator+(const CSPString& string, LPCTSTR lpsz)
{
	SP_ASSERT(lpsz == NULL || SP_IsValidString(lpsz));
	CSPString s;
...
CSPString  operator+(LPCTSTR lpsz, const CSPString& string)
{
	SP_ASSERT(lpsz == NULL || SP_IsValidString(lpsz));
	CSPString s;
...
CSPString  operator+(const CSPString& string1, TCHAR ch)
{
	CSPString s;
...
CSPString  operator+(TCHAR ch, const CSPString& string)
{
	CSPString s;
...
void  CSPString::Format(LPCTSTR lpszFormat, ...)
{
	// 暂不支持较长字符串
...
void  CSPString::Format(UINT nFormatID, ...)
{
	CSPString strFormat;
