...
#define	OEM_REGKEY_COMPANY	"ZLinker-Stock Software"// 注册表中的公司代号
#define	OEM_REGKEY_APP		"CLKingOEM"				// 注册表中的软件代号

#define	OEM_SUPPORT_MAILTO	"support@zlinker.com"	// 技术支持邮箱地址
#define	OEM_SERVER_DOMAIN	"www.zlinker.com"		// 公司网站地址，
													// 注：软件中历史数据下载要从该网址下载
