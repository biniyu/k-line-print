...
#if _MSC_VER < 1500 // MFC 6.0 or earlier
...
void CGridCtrl::AutoSize()
{
    ...
    int nNumColumns = GetColumnCount();
    int nCol,nRow,nNumRows = GetRowCount();
...
void CGridCtrl::ExpandColumnsToFit()
{
    ...
    int i,nColumnAdjustment = nDifference / GetColumnCount();
...
void CGridCtrl::ExpandRowsToFit()
{
    ...
    int i,nRowAdjustment = nDifference / GetRowCount();
...
BOOL CGridCtrl::Save(LPCTSTR filename)
{
    ...
    TRY {
        ...
        int i,nNumColumns = GetColumnCount();
