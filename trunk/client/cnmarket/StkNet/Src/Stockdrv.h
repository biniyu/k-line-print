...
#define     FILE_5MINUTE_EX         81          // 补5分钟K线数据
#define     FILE_MIN5_EX            81          // 补5分种K线数据   
#define     FILE_MIN1_EX            82          // 补1分钟数据,补分时线数据  


#define     FILE_MIN15_EX           84          // 补15分种K线数据  
#define     FILE_MIN30_EX           85          // 补30分种K线数据  
#define     FILE_MIN60_EX           86          // 补60分种K线数据  

#define     FILE_WEEK_EX            87          // 补周K线数据  
#define     FILE_MONTH_EX           88          // 补月K线数据  
...
#define     FILE_KDATA_DOWNLOAD     0x4000

#define     FILE_TODAY_KDATA        0x5000      //下载当天
#define     FILE_HISTORY_KDATA      0x6000      //下载指定日期区间
#define     QUOTE_SERVER_STATUS     0x9000
