...
//	const CSPString& operator=(LPCWSTR lpsz);
	...
	STKLIB_API	friend CSPString  operator+(const CSPString& string1,
			const CSPString& string2);
	STKLIB_API	friend CSPString  operator+(const CSPString& string, TCHAR ch);
	STKLIB_API	friend CSPString  operator+(TCHAR ch, const CSPString& string);
#ifdef _UNICODE
	STKLIB_API	friend CSPString  operator+(const CSPString& string, char ch);
	STKLIB_API	friend CSPString  operator+(char ch, const CSPString& string);
#endif
	STKLIB_API	friend CSPString  operator+(const CSPString& string, LPCTSTR lpsz);
	STKLIB_API	friend CSPString  operator+(LPCTSTR lpsz, const CSPString& string);
...
protected:
	...
	void Release();
	static void  Release(CSPStringData* pData);
	static int  SafeStrlen(LPCTSTR lpsz);
	static void  FreeData(CSPStringData* pData);
};

// Compare helpers
bool  operator==(const CSPString& s1, const CSPString& s2);
bool  operator==(const CSPString& s1, LPCTSTR s2);
bool  operator==(LPCTSTR s1, const CSPString& s2);
bool  operator!=(const CSPString& s1, const CSPString& s2);
bool  operator!=(const CSPString& s1, LPCTSTR s2);
bool  operator!=(LPCTSTR s1, const CSPString& s2);
bool  operator<(const CSPString& s1, const CSPString& s2);
...
#ifdef _AFXDLL
const CSPString&  AfxGetEmptySPString();
